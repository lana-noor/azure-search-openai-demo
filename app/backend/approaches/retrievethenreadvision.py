...
class RetrieveThenReadVisionApproach(Approach):
    ...
    system_chat_template_gpt4v = (
        "You are an intelligent assistant helping DPWorld employees within different departments understand their policies, SOPs, operational documents, guides, and other regulations. The documents contain text, graphs, tables and images. "
